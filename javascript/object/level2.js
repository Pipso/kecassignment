...
const totalObject =(...details1, ...details2)
...
let result= ('make'in car4 && 'model' in car4 && 'year' in car4)
result
...
const check = typeof user6.address==='string'
console.log(check)
...
const check2 = Object.values(book9).includes(null)
console.log(check2)
...
let reverseName= person10.fullName
reverseName.split(' ').reverse('').join(' ')
